...
- **한국 사진**: Naver / Google / HERE / Photon 중 선택하여 읍/면/동 단위 주소 보정
...
| 기능 | 설명 |
|------|------|
| 한국 역지오코딩 | Naver · Google · HERE · Photon 중 선택 |
...
| 변수 | 기본값 | 설명 |
|------|--------|------|
| `GEOCODING_KOREA` | `naver` | 한국: `naver` / `google` / `here` / `photon` / `disabled` |
...
| 항목 | 옵션 |
|------|------|
| 한국 | Naver Maps / Google Maps / HERE / Photon / 비활성화 |
